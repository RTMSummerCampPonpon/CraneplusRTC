...
{
	data[id-1].CW_ComplianceMargin = 5;
	data[id-1].CCW_ComplianceMargin = 5;
	data[id-1].CW_ComplianceSlope = 7;
	data[id-1].CCW_ComplianceSlope = 7;
	data[id-1].Angle = 150;
	data[id-1].Speed = 8;
	data[id-1].Torque = 0.75;
}
